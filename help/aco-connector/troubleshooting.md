...
# Solução de problemas no Adobe Commerce Optimizer Connector
...
- Confirme se o cliente OAuth tem os escopos necessários para o serviço de assimilação [!DNL Commerce Optimizer] (consulte [Obter Credenciais de IMS](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/authentication/#obtain-ims-credentials)).

## Dados não sincronizados

**Verificar detalhes do erro no nível do item:**

1. No Administrador do Commerce, vá para **[!UICONTROL System]** > **[!UICONTROL Data Transfer]** > **[!UICONTROL Data Feed Sync Status]**.
2. Selecione o feed com falha para visualizar os detalhes do erro por item.
