...
>[!TIP]
>
>Para adicionar vários usuários simultaneamente, você pode fazer um [upload CSV em massa](https://helpx.adobe.com/br/business/enterprise/users/users-and-groups/bulk-upload-users.html){target="_blank"}.
>
> Você também pode adicionar vários usuários a uma função criando um [grupo de usuários](https://helpx.adobe.com/br/business/enterprise/users/users-and-groups/user-groups.html){target="_blank"}. Em seguida, adicione os produtos apropriados ao grupo de usuários.
...
* **Usuários** - Os usuários têm acesso de Administrador ao Administrador do Commerce, mas não podem gerenciar o acesso no nível do produto no Admin Console. Os usuários também podem usar créditos para [criar instâncias](./getting-started.md#create-an-instance) no [!DNL Commerce Cloud Manager].
  ...
  >[!TIP]
  >
  >Para restringir o acesso ao Commerce Admin por endereço IP, consulte [Limitar o acesso ao produto por endereços IP](https://helpx.adobe.com/br/business/enterprise/identity-sso/set-up-identity/restrict-product-access-by-ip-address.html){target="_blank"}.

* [**Desenvolvedores**](https://helpx.adobe.com/br/business/enterprise/users/users-and-groups/manage-developers.html#Adddevelopers){target="_blank"} — Os desenvolvedores têm permissões de usuário e são adicionados à instância do Commerce como um usuário desenvolvedor. Eles podem usar os [[!DNL Admin UI SDK]](https://developer.adobe.com/commerce/extensibility/admin-ui-sdk/){target="_blank"}, [configurar eventos](https://developer.adobe.com/commerce/extensibility/events/){target="_blank"} e [criar webhooks](https://developer.adobe.com/commerce/extensibility/webhooks/){target="_blank"}.

* Administradores - Há diferentes tipos de funções administrativas:
  * [Administradores do sistema](https://helpx.adobe.com/br/business/enterprise/users/manage-admins/admin-roles-hierarchy.html){target="_blank"} - O administrador do sistema tem acesso a todos os produtos e perfis de produtos na organização por meio da Admin Console.
...
1. Clique no [!UICONTROL **Padrão — Perfil de produto Cloud Manager**].
...
Se sua conta tiver acesso a [[!DNL Adobe Experience Manager as a Cloud Service]](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service) e você quiser permitir que um usuário acesse os recursos avançados do [[!DNL AEM Assets]](https://experienceleague.adobe.com/pt-br/docs/commerce/aem-assets-integration/overview){target="_blank"} junto com o [!DNL Adobe Commerce as a Cloud Service], conclua o seguinte processo:

>[!NOTE]
>
>Os usuários sem as permissões de ativos apropriadas não podem acessar os recursos avançados do [!DNL AEM Assets], como a [geração de imagem de IA](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/ai-in-aem/overview){target="_blank"}, as [variações geradas](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/ai-in-aem/generate-variations/generate-variations-integrated-editor){target="_blank"} e muito mais.

>[!TIP]
>
>Para adicionar vários usuários simultaneamente, você pode fazer um [upload CSV em massa](https://helpx.adobe.com/br/business/enterprise/users/users-and-groups/bulk-upload-users.html){target="_blank"}.
>
>Você também pode adicionar vários usuários a uma função criando um [grupo de usuários](https://helpx.adobe.com/br/business/enterprise/users/users-and-groups/user-groups.html){target="_blank"}. Em seguida, você pode adicionar o produto [!DNL **Adobe Experience Manager as a Cloud Service**] ao grupo de usuários.
...
Para confirmar se o usuário tem acesso, clique no nome do usuário para abrir a página de perfil. Na seção [!UICONTROL **Produtos**], [!UICONTROL **Concluído**] é exibido abaixo do produto [!UICONTROL **Adobe Experience Manager as a Cloud Service**]. Leva alguns segundos depois de adicionar o usuário para ver o status atualizado em seu perfil. Atualize a página para ver o status atualizado.
...
1. [Criar um novo ambiente](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-manager/content/requirements/users-and-roles){target="_blank"}.
...
1. Agora você deve ver novos perfis de produto. Selecione aquele que contém `- author -`. Por exemplo, `<environment-name> - author - <program-id> - <environment-id>`.
