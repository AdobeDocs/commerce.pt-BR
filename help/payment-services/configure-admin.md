...
Em versões anteriores, o mapeamento de conta do PayPal no nível do site normalmente exigia que você [contatasse o Suporte](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case) ou o representante da Adobe. Use a ação **[!UICONTROL Connect different account]** quando atender aos pré-requisitos abaixo.
...
| [!UICONTROL Payment Action] | site | A [ação de pagamento](https://experienceleague.adobe.com/en/docs/commerce-admin/config/sales/payment-methods/payment-methods) para o método de pagamento especificado. Opções: [!UICONTROL Authorize] / [!UICONTROL Authorize and Capture] |
...
Consulte [Funções de usuário](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions-user-roles) para saber como gerenciar funções.
...
Consulte [Escopo de Site, Armazenamento e Exibição](https://experienceleague.adobe.com/en/docs/commerce-admin/start/setup/websites-stores-views) para obter mais informações sobre a hierarquia de sites, lojas e exibições de loja.
