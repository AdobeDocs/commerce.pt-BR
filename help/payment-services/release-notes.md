...
![Problema corrigido](../assets/fix.svg)<!-- PAY-6164 --> Agora, [!DNL Payment Services] usa a moeda base para os métodos de envio disponíveis no **SSSC (retorno de chamada de envio no lado do servidor) do PayPal**.
