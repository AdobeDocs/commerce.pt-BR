...
>[!MORELIKETHIS]
>
> * [[!DNL Adobe Commerce] 2.4 Guia do Usuário](https://experienceleague.adobe.com/en/docs/commerce-admin/user-guides/home)—Documentação focada no comerciante para [!DNL Adobe Commerce] e [!DNL Magento Open Source]
> * [[!DNL Adobe Commerce] 2.4 Guia do Usuário](https://experienceleague.adobe.com/en/docs/commerce-admin/user-guides/home)—Documentação focada no desenvolvedor usada para compilar e personalizar o [!DNL Adobe Commerce] ou o [!DNL Magento Open Source]
...
> * [Centro de ajuda](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/overview)—Procure por artigos de solução de problemas relacionados a [!DNL Payment Services] na base de conhecimento
> * [Tíquetes de suporte](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case) — os clientes da Commerce podem enviar um tíquete para receber ajuda adicional
