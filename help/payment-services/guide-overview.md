...
>[!MORELIKETHIS]
>
> * [[!DNL Adobe Commerce] 2.4 Guia do Usuário](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/user-guides/home)—Documentação focada no comerciante para [!DNL Adobe Commerce] e [!DNL Magento Open Source]
> * [[!DNL Adobe Commerce] 2.4 Guia do Usuário](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/user-guides/home)—Documentação focada no desenvolvedor usada para compilar e personalizar o [!DNL Adobe Commerce] ou o [!DNL Magento Open Source]
...
> * [Centro de ajuda](https://experienceleague.adobe.com/pt-br/docs/commerce-knowledge-base/kb/overview)—Procure por artigos de solução de problemas relacionados a [!DNL Payment Services] na base de conhecimento
> * [Tíquetes de suporte](https://experienceleague.adobe.com/pt-br/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case) — os clientes da Commerce podem enviar um tíquete para receber ajuda adicional

## Suporte

Se precisar de informações ou se tiver dúvidas não abordadas neste guia sobre o [!DNL Payment Services], contate o representante de vendas do [!DNL Payment Services] ou use os recursos disponíveis na sua Página Inicial do [!DNL Payment Services]:
