...
breadcrumb-title: Integração do [!DNL AEM Assets]
...
- [Metadados do Commerce no AEM Assets](metadata.md)
- Introdução {#get-started}
   ...
   - [Exibir status de sincronização do AEM Assets](get-started/sync-status.md)
