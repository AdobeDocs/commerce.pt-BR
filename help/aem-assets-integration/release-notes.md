...
![Correção de um problema](../assets/fix.svg)<!-- Issue ACAP-1180 --> Melhorias gerais na página de edição do produto. Agora, as páginas são pré-renderizadas corretamente quando a integração do AEM Assets é ativada.
