...
Para obter mais informações sobre a sincronização de dados do [!DNL Catalog Service], consulte o [Painel de Gerenciamento de Dados](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/systems/data-transfer/data-dashboard).
