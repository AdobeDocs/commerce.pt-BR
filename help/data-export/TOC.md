...
- Sincronizar dados {#data-synchronization}
...
- Extensibilidade {#extensibility}
  ...
  - [Adicionar atributos de produto dinamicamente](add-attribute-dynamically.md)
...
- Solução de problemas {#troubleshooting}
  ...
  - [Referência de códigos de log](troubleshooting/log-codes-reference.md)
