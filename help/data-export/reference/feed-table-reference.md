...
Use as seguintes consultas SQL para inspecionar diretamente o estado da tabela de feed. Substitua valores de espaço reservado como `<SKU>`, `<ATTRIBUTE_CODE>` e `<CATEGORY_ID>` por valores reais do seu ambiente. Consulte [Feeds com suporte](#supported-feeds) para obter a lista completa de nomes de tabela.
...
**Feed de substituições de produto — por SKU:**
...
**Feed de categorias — por ID de categoria:**
...
**Feed de variantes — por SKU de produto configurável:**
