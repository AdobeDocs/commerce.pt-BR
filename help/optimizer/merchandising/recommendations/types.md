...
- Acione as [recomendações de backup](../../setup/events/overview.md#backup-recommendations), como mostrar os produtos do `Most viewed` quando as recomendações personalizadas ainda não estiverem disponíveis.
...
| Semelhança visual | Recomenda produtos com aparência semelhante ao produto que está sendo visualizado. Esse tipo de recomendação é mais útil quando imagens e aspectos visuais dos produtos são partes importantes da experiência de compra.<br/><br/>**Onde usado:**<br>- Detalhes do produto <br/><br/>**Rótulos sugeridos:**<br/> -Você também pode gostar<br/> -Encontramos outros produtos que você pode gostar<br/> -Inspirado neste estilo |
