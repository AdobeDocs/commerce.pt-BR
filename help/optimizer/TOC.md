...
- [Integrações](./integrations/integrations-overview.md)
...
- Gerenciamento de resultados {#manage-results}
  ...
  - {hide-from-toc}[Pesquisar correspondência e classificação](./manage-results/search-relevance-matching.md)
...
- Configuração da loja {#setup}
  - [Origens do catálogo](./setup/catalog-sources.md)
  - [Exibições de catálogo](./setup/catalog-view.md)
  - [Exibições de catálogo privado](./setup/private-catalog-view.md)
  - [Chaves de acesso restrito](./setup/restricted-access-keys.md)
  - [Camadas do catálogo](./setup/catalog-layer.md)
  - [Políticas](./setup/policies.md)
  - [Catálogos de preços](./setup/pricebooks.md)
  - [Visuais do produto](./setup/product-visuals.md)
  - [Sincronização de dados](./setup/data-sync.md)
  - [Pesquisa semântica](./setup/semantic-search.md)
  - Eventos {#events}
