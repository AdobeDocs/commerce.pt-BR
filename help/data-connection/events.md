...
>[!NOTE]
>
>Todos os eventos comportamentais incluem o campo [`identityMap`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/field-groups/profile/identitymap), que inclui o endereço de email do comprador, quando disponível, e a ECID.
