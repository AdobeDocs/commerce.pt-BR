...
1. Ao concluir, clique em **Salvar e publicar**.
   ...
   >[!IMPORTANT]
   >
   >Se o botão **[!UICONTROL Save and publish]** estiver esmaecido, verifique se você inseriu todas as informações necessárias para a regra, incluindo o nome da regra.
