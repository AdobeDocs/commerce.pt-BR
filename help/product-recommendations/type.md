...
Os tipos de recomendação de venda cruzada e venda adicional usam o contexto da página em que a unidade de recomendação é exibida. Esse contexto informa o sistema sobre qual produto ou quais produtos devem ser usados ao localizar itens relacionados:
...
| Tipo | Descrição |
|---|---|
| Mais visualizados | Recomenda produtos que foram mais visualizados ao contar o número de sessões em que uma ação de visualização ocorreu nos últimos sete dias.<br/><br/>**Onde usado:**<br/>- Página inicial<br/>- Categoria<br/>- Detalhes do produto<br/>- Carrinho<br/>- Confirmação<br/>- Construtor de páginas <br/><br/>**Rótulos sugeridos:**<br/>- Mais popular<br/>- Tendências<br/>- Popular no momento<br/>- Popular no momento<br/>- Produtos populares inspirados neste produto (PDP)<br/>- Principais vendedores |
...
Após ativar as recomendações visuais, o Adobe AI inicia o processamento da imagem. O tempo de duração depende do tamanho do catálogo.
