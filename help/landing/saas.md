...
Se você não for o proprietário da licença, deverá obter as chaves da API do Commerce da pessoa ou equipe proprietária da licença da Commerce para sua loja.

>[!NOTE]
>
>As chaves de API só podem ser geradas pelo proprietário da licença. Não há recurso de acesso compartilhado para permitir que outros usuários os gerem.
