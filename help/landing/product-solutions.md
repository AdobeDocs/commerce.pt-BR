...
>[!NOTE]
>
>Para obter mais informações sobre os recursos disponíveis no [!DNL Adobe Commerce as a Cloud Service] (SaaS) e como esses recursos estão alinhados com outras versões do Adobe Commerce, como o [!DNL Adobe Commerce on Cloud] e o [!DNL Adobe Commerce on Premises] (PaaS), consulte a [Comparação de recursos](../cloud-service/feature-comparison.md).
